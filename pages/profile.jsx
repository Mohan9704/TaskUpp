                  ...
                  <div className="pt-4 flex flex-col bg-gray-100 dark:bg-gray-900/70 shadow-2xl w-[450px] h-[520px] rounded-2xl  mx-auto  transition duration-300 ease-in">
                    <div className="flex flex-col space-y-6 flex-1 px-12 py-4 pt-6 ">
                      ...
                      <div className="flex flex-col space-y-3">
                        ...
                        <div className="group flex border-[1px] border-gray-500 dark:border-[1px] dark:border-gray-700 px-2 py-2 rounded-lg  hover:ring-1 hover:ring-violet-600 transition duration-300 ease-in">
                          <MailIcon className="h-6 w-6 text-gray-500 dark:text-violet- transition duration-300 ease-in" />
                          <input
                            type="email"
                            id="email"
                      ...
                      <div className="flex flex-col space-y-3">
                        ...
                        <div className=" flex border-[1px] border-gray-500 dark:border-[1px] dark:border-gray-700 px-2 py-2 rounded-lg  hover:ring-1 hover:ring-violet-600 transition duration-300 ease-in">
