...
const Onboarding = ({
  ...
  return (
    <div className="flex h-full flex-col lg:grid lg:grid-cols-10  bg-gray-100">
        ...
        <div className="flex items-center h-[220px] space-x-16 w-[900px]  px-8 ">
          ...
          <div className="flex flex-col space-y-10">
            ...
            <button
              ...
              className=" text-lg text-white bg-violet-500 font-medium rounded-md p-2 w-[200px] "
            >
              Play with Taskupp
            </button>
          </div>
      ...
      <div
        className={`lg:col-span-4 flex flex-1 flex-col p-12 transition duartion-300 ease-in  bg-violet-600 `}
      ></div>
    </div>
  );
};
