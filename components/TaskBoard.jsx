        ...
        <div
          ...
          className={`${
            snapshot.isDraggingOver
              ? "bg-gray-300  border-[3px] border-dashed border-violet-600 dark:border-violet-400 dark:bg-gray-700 "
              : ""
        ...
        >
          <div className="z-10 flex items-center justify-between font-semibold bg-gray-50 dark:bg-gray-100/10 rounded-lg py-2 px-3 transition duration-300 ease-in ml-1  mr-3">
            ...
            <div className="flex items-center  space-x-4">
              ...
              <div className="  bg-violet-200 rounded-md dark:bg-violet-600 flex items-center justify-center hover:ring-2 ring-gray-500 transition-all">
                <PlusSmIcon
                  onClick={handleShowEditableTask}
                  className=" w-5 h-5 md:w-6 md:h-6 text-violet-500 dark:text-violet-200 "
                />
              </div>
            </div>
          </div>
