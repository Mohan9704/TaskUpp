            ...
            <div className="flex justify-between ">
              {card?.date && (
                <button className="flex space-x-2  px-2 py-1 rounded-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 hover:bg-opacity-80 bg-gray-200 dark:bg-gray-600 transition duration-300 ease-in">
                  <ClockIcon className=" w-5 h-5 text-violet-600 dark:text-violet-300 " />
                  <p className="text-sm font-manrope font-medium text-gray-800 dark:text-gray-100">
                     {card?.date}
                  </p>
                </button>
              )}
              <div className="flex space-x-2 right-2 bottom-5 rounded-lg bg-gray-200 dark:bg-violet-600 px-2 py-1  transition duration-300 ease-in ">
                <ClipboardCheckIcon className=" w-5 h-5 text-violet-600 dark:text-violet-200 " />
                <p className="text-sm font-manrope font-medium text-gray-800 dark:text-gray-100">
