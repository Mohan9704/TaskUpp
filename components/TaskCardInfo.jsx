        ...
        <div className="relative bg-gray-100 z-50 dark:bg-gray-800 max-h-[650px] w-[510px] rounded-xl shadow-2xl mx-auto py-4 mt-6 ">
          <div className=" space-y-4 max-h-[570px] w-[510px] overflow-y-scroll custom-scroll">
            ...
            <div className="flex flex-col space-y-2 px-6">
              <div className="flex  justify-between items-center ">
                <span className="  flex items-center space-x-2 decoration-none font-inter px-2 py-2 text-gray-800 font-semibold ">
                  <BookmarkIcon className=" w-5 h-5 text-violet-500 dark:text-violet-200 " />
            ...
            <div className="flex item-center flex-col space-y-2 px-6">
              <div className="flex  justify-between items-center ">
                <span className="  flex items-center space-x-2 decoration-none font-inter px-2 py-2 text-gray-800 font-semibold ">
                  <MenuAlt1Icon className=" w-5 h-5 text-violet-500 dark:text-violet-200 " />
                  <p className="  text-md  font-inter font-bold text-gray-800  dark:text-gray-100">
                    Description
                  </p>
                </span>
            ...
            <div className="flex item-center flex-col space-y-2 px-6">
              <div className="flex  justify-between items-center ">
                <span className="  flex items-center space-x-2 decoration-none font-inter px-2 py-2 text-gray-800 font-semibold ">
                  <CalendarIcon className=" w-5 h-5 text-violet-500 dark:text-violet-200 " />
                  <p className="  text-md font-inter font-bold text-gray-800  dark:text-gray-100">
                    Date
                  </p>
                </span>
            ...
            <div className="flex item-center flex-col space-y-2 px-6">
              <div className="flex  justify-between items-center ">
                <span className="  flex items-center space-x-2 decoration-none font-inter px-2 py-2 text-gray-800 font-semibold ">
                  <TagIcon className=" w-5 h-5 text-violet-500 dark:text-violet-200 " />
                  <p className="  text-md font-inter font-bold text-gray-800  dark:text-gray-100">
                    Labels
                  </p>
                </span>
                    ...
                    <div className="flex  space-x-4 ">
                      ...
                      <div className="  flex justify-between items-center">
                        <button
                          ...
                          className=" label bg-violet-200 dark:bg-violet-600 text-sm px-2  py-2 font-inter font-bold text-violet-600 dark:text-violet-200 shadow-md hover:shadow-2xl hover:opacity-80"
                        >
                          Add Label
                        </button>
                      </div>
            ...
            <div className="flex item-center flex-col space-y-2 px-6 ">
              <div className="flex  justify-between items-center ">
                <span className="  flex items-center space-x-2 decoration-none font-inter px-2 py-2 text-gray-800 font-semibold ">
                  <ClipboardListIcon className=" w-5 h-5 text-violet-500 dark:text-violet-200 " />
                  <p className="  text-md font-inter font-bold text-gray-800  dark:text-gray-100">
                    Tasks
                  </p>
                </span>
              ...
              <div className="w-full h-[8px] border-1 border-gray-800 dark:border-gray-100 bg-gray-700/30 dark:bg-gray-50/20 rounded-[3px] mx-2">
                <div
                  ...
                  className=" rounded-[3px] h-[8px] bg-violet-600 dark:bg-violet-500"
                />
              </div>
              {/* Progress Bar */}
                ...
                {!editField.tasks ? (
                  <div className="flex flex-col  space-y-[10px] ">
                    {tempCard?.tasks.map((item) => (
                      <div
                        key={item.id}
                        className="accent-violet-500 flex justify-between "
                      >
          ...
          <div className="flex justify-end px-4  w-full pt-2 ">
            <div className="flex justify-end space-x-4  items-center ">
              <button
                ...
                className=" label bg-violet-200 dark:bg-violet-600 text-sm px-3  py-2 font-inter font-bold text-violet-600 dark:text-violet-200 shadow-md hover:shadow-2xl hover:opacity-80"
              >
                Update Card
              </button>
              <button
                onClick={handleShowModal}
                className="flex label bg-violet-600 dark:bg-violet-200 text-sm px-3  py-2 font-inter font-bold text-violet-100 dark:text-violet-500 shadow-md hover:shadow-2xl hover:opacity-80"
              >
                Cancel
                <div className="flex pt-[2px]">
                  <XIcon className="ml-1 w-4 h-4 text-violet-100  dark:text-violet-500 " />
                </div>
              </button>
            </div>
          </div>
