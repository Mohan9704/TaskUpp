          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex border-[1px] border-gray-500 dark:border-[1px] dark:border-gray-600 px-2 py-2 rounded-lg hover:ring-1 hover:ring-violet-600 transition duration-300 ease-in">
              ...
              <input
                ...
                className="pl-2 bg-gray-100 dark:bg-gray-800 text-sm font-normal  text-gray-500 dark:text-gray-600 font-inter outline-none ml-2 w-full  transition duration-300 ease-in"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-3 ">
            ...
            <div className="flex border-[1px] border-gray-500 dark:border-[1px] dark:border-gray-600 px-2 py-2 rounded-lg hover:ring-1 hover:ring-violet-600 transition duration-300 ease-in">
              ...
              <input
                ...
                className="pl-2 bg-gray-100 dark:bg-gray-800 text-sm font-normal g text-gray-500 dark:text-gray-600 font-inter outline-none ml-2 w-full  transition duration-300 ease-in"
              />
            </div>
          </div>
